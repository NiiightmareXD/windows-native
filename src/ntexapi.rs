...
use windows::{
    ...
    Win32::{
        ...
        System::{
            Diagnostics::{
                Debug::XSTATE_CONFIGURATION,
                Etw::{
                    EVENT_TRACE_FLAG_ALPC, EVENT_TRACE_FLAG_DBGPRINT,
                    EVENT_TRACE_FLAG_DEBUG_EVENTS, EVENT_TRACE_FLAG_DISK_FILE_IO,
                    EVENT_TRACE_FLAG_DISK_IO, EVENT_TRACE_FLAG_DISK_IO_INIT,
                    EVENT_TRACE_FLAG_FILE_IO, EVENT_TRACE_FLAG_FILE_IO_INIT,
                    EVENT_TRACE_FLAG_IMAGE_LOAD, EVENT_TRACE_FLAG_JOB,
                    ...
                    EVENT_TRACE_TYPE_CONFIG_PROCESSORNUMBER, EVENT_TRACE_TYPE_CONFIG_SERVICES,
                    EVENT_TRACE_TYPE_CONFIG_VIDEO, EVENT_TRACE_TYPE_CONNECT,
                    EVENT_TRACE_TYPE_CONNFAIL, EVENT_TRACE_TYPE_COPY_ARP,
                    ...
                    EVENT_TRACE_TYPE_INFO, EVENT_TRACE_TYPE_IO_FLUSH,
                    EVENT_TRACE_TYPE_IO_FLUSH_INIT, EVENT_TRACE_TYPE_IO_READ,
                    EVENT_TRACE_TYPE_IO_READ_INIT, EVENT_TRACE_TYPE_IO_REDIRECTED_INIT,
                    EVENT_TRACE_TYPE_IO_WRITE, EVENT_TRACE_TYPE_IO_WRITE_INIT,
                    EVENT_TRACE_TYPE_LOAD, EVENT_TRACE_TYPE_MM_AV, EVENT_TRACE_TYPE_MM_COW,
                    EVENT_TRACE_TYPE_MM_DZF, EVENT_TRACE_TYPE_MM_GPF, EVENT_TRACE_TYPE_MM_HPF,
                    EVENT_TRACE_TYPE_MM_TF, EVENT_TRACE_TYPE_OPTICAL_IO_FLUSH,
...
use crate::{
    ...
    phnt_ntdef::{KSYSTEM_TIME, TRACEHANDLE},
};
...
pub const SYSDBG_LIVEDUMP_CONTROL_SIZE_WIN11: u32 = size_of::<SYSDBG_LIVEDUMP_CONTROL>() as u32;
pub const ATOM_FLAG_GLOBAL: u32 = 2;
pub const SYSDBG_LIVEDUMP_CONTROL_SIZE: u32 = offset_of!(SYSDBG_LIVEDUMP_CONTROL, AddPagesControl)
    as u32
...
pub struct TIMER_SET_COALESCABLE_TIMER_INFO {
    ...
    pub TimerContext: *mut std::ffi::c_void,
    pub WakeContext: *mut COUNTED_REASON_CONTEXT,
    pub Period: u32,
    pub TolerableDelay: u32,
    pub PreviousState: *mut BOOLEAN,
}
...
impl std::fmt::Debug for TIMER_SET_COALESCABLE_TIMER_INFO {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "TIMER_SET_COALESCABLE_TIMER_INFO {{ TimerApcRoutine: {:?}, WakeContext: {:?} }}",
            self.TimerApcRoutine, self.WakeContext
        )
    }
}
extern "C" {
...
impl std::fmt::Debug for SYSTEM_FIRMWARE_TABLE_INFORMATION {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "SYSTEM_FIRMWARE_TABLE_INFORMATION {{ Action: {:?}, TableBuffer: {:?} }}",
            self.Action, self.TableBuffer
        )
    }
}
...
pub struct SYSTEM_FIRMWARE_TABLE_HANDLER {
    ...
    pub DriverObject: *mut std::ffi::c_void,
}
...
impl std::fmt::Debug for SYSTEM_FIRMWARE_TABLE_HANDLER {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "SYSTEM_FIRMWARE_TABLE_HANDLER {{ FirmwareTableHandler: {:?} }}",
            self.FirmwareTableHandler
        )
    }
}
#[repr(C)]
...
impl std::fmt::Debug for SYSTEM_CODEINTEGRITY_INFORMATION {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "SYSTEM_CODEINTEGRITY_INFORMATION {{  }}")
    }
}
#[repr(C)]
...
pub struct KUSER_SHARED_DATA {
    ...
    pub Anonymous1: KUSER_SHARED_DATA_1,
    ...
    pub Anonymous2: KUSER_SHARED_DATA_2,
    pub Reserved12: [u8; 2usize],
    pub Anonymous3: KUSER_SHARED_DATA_3,
    pub DataFlagsPad: [u32; 1usize],
    pub TestRetInstruction: u64,
    pub QpcFrequency: i64,
    pub SystemCall: u32,
    pub Reserved2: u32,
    pub SystemCallPad: [u64; 2usize],
    pub Anonymous4: KUSER_SHARED_DATA_4,
    pub Cookie: u32,
    pub CookiePad: [u32; 1usize],
    ...
    pub EnclaveFeatureMask: [u32; 4usize],
    ...
    pub Reserved9: u8,
    pub Anonymous5: KUSER_SHARED_DATA_5,
...
#[repr(C)]
pub struct KUSER_SHARED_DATA_1 {
    pub MitigationPolicies: UnionField<u8>,
    pub Anonymous1: UnionField<KUSER_SHARED_DATA_1_1>,
    pub union_field: u8,
}
#[repr(C, packed)]
pub struct KUSER_SHARED_DATA_1_1 {
    _bitfield_align_1: [u8; 0],
    _bitfield_1: BitfieldUnit<[u8; 1usize]>,
}
impl Default for KUSER_SHARED_DATA_1_1 {
    fn default() -> Self {
        unsafe { std::mem::zeroed() }
    }
}
impl std::fmt::Debug for KUSER_SHARED_DATA_1_1 {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "KUSER_SHARED_DATA_1_1 {{ NXSupportPolicy : {:?}, SEHValidationPolicy : {:?}, CurDirDevicesSkippedForDlls : {:?}, Reserved : {:?} }}",
            self.NXSupportPolicy(),
            self.SEHValidationPolicy(),
            self.CurDirDevicesSkippedForDlls(),
            self.Reserved()
        )
    }
}
impl KUSER_SHARED_DATA_1_1 {
    #[inline]
    pub fn NXSupportPolicy(&self) -> u8 {
        self._bitfield_1.get(0usize, 2u8) as u8
    }
    #[inline]
    pub fn set_NXSupportPolicy(&mut self, val: u8) {
    ...
    #[inline]
    pub fn set_SEHValidationPolicy(&mut self, val: u8) {
    ...
    #[inline]
    pub fn set_CurDirDevicesSkippedForDlls(&mut self, val: u8) {
    ...
    pub fn new_bitfield_1(
        NXSupportPolicy: u8,
        SEHValidationPolicy: u8,
        CurDirDevicesSkippedForDlls: u8,
        Reserved: u8,
    ) -> BitfieldUnit<[u8; 1usize]> {
        let mut bitfield_unit: BitfieldUnit<[u8; 1usize]> = Default::default();
        bitfield_unit.set(0usize, 2u8, NXSupportPolicy as u64);
        bitfield_unit.set(2usize, 2u8, SEHValidationPolicy as u64);
        bitfield_unit.set(4usize, 2u8, CurDirDevicesSkippedForDlls as u64);
...
impl std::fmt::Debug for KUSER_SHARED_DATA_1 {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "KUSER_SHARED_DATA_1 {{ union }}")
    }
}
#[repr(C)]
pub struct KUSER_SHARED_DATA_2 {
    pub VirtualizationFlags: UnionField<u8>,
    pub union_field: u8,
}
...
impl std::fmt::Debug for KUSER_SHARED_DATA_2 {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "KUSER_SHARED_DATA_2 {{ union }}")
    }
}
#[repr(C)]
pub struct KUSER_SHARED_DATA_3 {
    pub SharedDataFlags: UnionField<u32>,
    pub Anonymous1: UnionField<KUSER_SHARED_DATA_3_1>,
    pub union_field: u32,
}
#[repr(C)]
#[repr(align(4))]
pub struct KUSER_SHARED_DATA_3_1 {
    _bitfield_align_1: [u32; 0],
    _bitfield_1: BitfieldUnit<[u8; 4usize]>,
}
impl Default for KUSER_SHARED_DATA_3_1 {
    fn default() -> Self {
        unsafe { std::mem::zeroed() }
    }
}
impl std::fmt::Debug for KUSER_SHARED_DATA_3_1 {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "KUSER_SHARED_DATA_3_1 {{ DbgErrorPortPresent : {:?}, DbgElevationEnabled : {:?}, DbgVirtEnabled : {:?}, DbgInstallerDetectEnabled : {:?}, DbgLkgEnabled : {:?}, DbgDynProcessorEnabled : {:?}, DbgConsoleBrokerEnabled : {:?}, DbgSecureBootEnabled : {:?}, DbgMultiSessionSku : {:?}, DbgMultiUsersInSessionSku : {:?}, DbgStateSeparationEnabled : {:?}, SpareBits : {:?} }}",
            self.DbgErrorPortPresent(),
            self.DbgElevationEnabled(),
            self.DbgVirtEnabled(),
            self.DbgInstallerDetectEnabled(),
            self.DbgLkgEnabled(),
            self.DbgDynProcessorEnabled(),
            self.DbgConsoleBrokerEnabled(),
            self.DbgSecureBootEnabled(),
            self.DbgMultiSessionSku(),
            self.DbgMultiUsersInSessionSku(),
            self.DbgStateSeparationEnabled(),
            self.SpareBits()
        )
    }
}
impl KUSER_SHARED_DATA_3_1 {
    #[inline]
    pub fn DbgErrorPortPresent(&self) -> u32 {
        self._bitfield_1.get(0usize, 1u8) as u32
    }
    #[inline]
    pub fn set_DbgErrorPortPresent(&mut self, val: u32) {
        self._bitfield_1.set(0usize, 1u8, val as u64)
    }
    #[inline]
    pub fn DbgElevationEnabled(&self) -> u32 {
        self._bitfield_1.get(1usize, 1u8) as u32
    }
    #[inline]
    pub fn set_DbgElevationEnabled(&mut self, val: u32) {
        self._bitfield_1.set(1usize, 1u8, val as u64)
    }
    #[inline]
    pub fn DbgVirtEnabled(&self) -> u32 {
        self._bitfield_1.get(2usize, 1u8) as u32
    }
    #[inline]
    pub fn set_DbgVirtEnabled(&mut self, val: u32) {
        self._bitfield_1.set(2usize, 1u8, val as u64)
    }
    #[inline]
    pub fn DbgInstallerDetectEnabled(&self) -> u32 {
        self._bitfield_1.get(3usize, 1u8) as u32
    }
    #[inline]
    pub fn set_DbgInstallerDetectEnabled(&mut self, val: u32) {
        self._bitfield_1.set(3usize, 1u8, val as u64)
    }
    #[inline]
    pub fn DbgLkgEnabled(&self) -> u32 {
        self._bitfield_1.get(4usize, 1u8) as u32
    }
    #[inline]
    pub fn set_DbgLkgEnabled(&mut self, val: u32) {
        self._bitfield_1.set(4usize, 1u8, val as u64)
    }
    #[inline]
    pub fn DbgDynProcessorEnabled(&self) -> u32 {
        self._bitfield_1.get(5usize, 1u8) as u32
    }
    #[inline]
    pub fn set_DbgDynProcessorEnabled(&mut self, val: u32) {
        self._bitfield_1.set(5usize, 1u8, val as u64)
    }
    #[inline]
    pub fn DbgConsoleBrokerEnabled(&self) -> u32 {
        self._bitfield_1.get(6usize, 1u8) as u32
    }
    #[inline]
    pub fn set_DbgConsoleBrokerEnabled(&mut self, val: u32) {
        self._bitfield_1.set(6usize, 1u8, val as u64)
    }
    #[inline]
    pub fn DbgSecureBootEnabled(&self) -> u32 {
        self._bitfield_1.get(7usize, 1u8) as u32
    }
    #[inline]
    pub fn set_DbgSecureBootEnabled(&mut self, val: u32) {
        self._bitfield_1.set(7usize, 1u8, val as u64)
    }
    #[inline]
    pub fn DbgMultiSessionSku(&self) -> u32 {
        self._bitfield_1.get(8usize, 1u8) as u32
    }
    #[inline]
    pub fn set_DbgMultiSessionSku(&mut self, val: u32) {
        self._bitfield_1.set(8usize, 1u8, val as u64)
    }
    #[inline]
    pub fn DbgMultiUsersInSessionSku(&self) -> u32 {
        self._bitfield_1.get(9usize, 1u8) as u32
    }
    #[inline]
    pub fn set_DbgMultiUsersInSessionSku(&mut self, val: u32) {
        self._bitfield_1.set(9usize, 1u8, val as u64)
    }
    #[inline]
    pub fn DbgStateSeparationEnabled(&self) -> u32 {
        self._bitfield_1.get(10usize, 1u8) as u32
    }
    #[inline]
    pub fn set_DbgStateSeparationEnabled(&mut self, val: u32) {
        self._bitfield_1.set(10usize, 1u8, val as u64)
    }
    #[inline]
    pub fn SpareBits(&self) -> u32 {
        self._bitfield_1.get(11usize, 21u8) as u32
    }
    #[inline]
    ...
    #[inline]
    pub fn new_bitfield_1(
        DbgErrorPortPresent: u32,
        DbgElevationEnabled: u32,
        DbgVirtEnabled: u32,
        DbgInstallerDetectEnabled: u32,
        DbgLkgEnabled: u32,
        DbgDynProcessorEnabled: u32,
        DbgConsoleBrokerEnabled: u32,
        DbgSecureBootEnabled: u32,
        DbgMultiSessionSku: u32,
        DbgMultiUsersInSessionSku: u32,
        DbgStateSeparationEnabled: u32,
        SpareBits: u32,
    ) -> BitfieldUnit<[u8; 4usize]> {
        let mut bitfield_unit: BitfieldUnit<[u8; 4usize]> = Default::default();
        bitfield_unit.set(0usize, 1u8, DbgErrorPortPresent as u64);
        bitfield_unit.set(1usize, 1u8, DbgElevationEnabled as u64);
        bitfield_unit.set(2usize, 1u8, DbgVirtEnabled as u64);
        bitfield_unit.set(3usize, 1u8, DbgInstallerDetectEnabled as u64);
        bitfield_unit.set(4usize, 1u8, DbgLkgEnabled as u64);
        bitfield_unit.set(5usize, 1u8, DbgDynProcessorEnabled as u64);
        bitfield_unit.set(6usize, 1u8, DbgConsoleBrokerEnabled as u64);
        bitfield_unit.set(7usize, 1u8, DbgSecureBootEnabled as u64);
        bitfield_unit.set(8usize, 1u8, DbgMultiSessionSku as u64);
        bitfield_unit.set(9usize, 1u8, DbgMultiUsersInSessionSku as u64);
        bitfield_unit.set(10usize, 1u8, DbgStateSeparationEnabled as u64);
        bitfield_unit.set(11usize, 21u8, SpareBits as u64);
        bitfield_unit
    }
}
...
impl std::fmt::Debug for KUSER_SHARED_DATA_3 {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "KUSER_SHARED_DATA_3 {{ union }}")
    }
}
#[repr(C)]
pub struct KUSER_SHARED_DATA_4 {
    pub TickCount: UnionField<KSYSTEM_TIME>,
    pub TickCountQuad: UnionField<u64>,
    pub Anonymous1: UnionField<KUSER_SHARED_DATA_4_1>,
    pub union_field: [u64; 2usize],
}
#[repr(C)]
pub struct KUSER_SHARED_DATA_4_1 {
    pub ReservedTickCountOverlay: [u32; 3usize],
    pub TickCountPad: [u32; 1usize],
}
impl Default for KUSER_SHARED_DATA_4_1 {
    fn default() -> Self {
        unsafe { std::mem::zeroed() }
    }
}
impl std::fmt::Debug for KUSER_SHARED_DATA_4_1 {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "KUSER_SHARED_DATA_4_1 {{ ReservedTickCountOverlay: {:?}, TickCountPad: {:?} }}",
            self.ReservedTickCountOverlay, self.TickCountPad
        )
    }
}
...
impl std::fmt::Debug for KUSER_SHARED_DATA_4 {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "KUSER_SHARED_DATA_4 {{ union }}")
    }
}
#[repr(C)]
pub struct KUSER_SHARED_DATA_5 {
    pub QpcData: UnionField<u16>,
    pub Anonymous1: UnionField<KUSER_SHARED_DATA_5_1>,
    pub union_field: u16,
}
#[repr(C)]
pub struct KUSER_SHARED_DATA_5_1 {
    pub QpcBypassEnabled: u8,
    pub QpcShift: u8,
}
impl Default for KUSER_SHARED_DATA_5_1 {
    fn default() -> Self {
        unsafe { std::mem::zeroed() }
    }
}
impl std::fmt::Debug for KUSER_SHARED_DATA_5_1 {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "KUSER_SHARED_DATA_5_1 {{  }}")
    }
}
impl Default for KUSER_SHARED_DATA_5 {
    fn default() -> Self {
        unsafe { std::mem::zeroed() }
    }
}
impl std::fmt::Debug for KUSER_SHARED_DATA_5 {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "KUSER_SHARED_DATA_5 {{ union }}")
    }
}
...
impl std::fmt::Debug for KUSER_SHARED_DATA {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "KUSER_SHARED_DATA {{ NtSystemRoot: {:?}, Reserved0: {:?}, ProcessorFeatures: {:?}, AlternativeArchitecture: {:?}, Anonymous1: {:?}, Anonymous2: {:?}, Reserved12: {:?}, Anonymous3: {:?}, DataFlagsPad: {:?}, SystemCallPad: {:?}, Anonymous4: {:?}, CookiePad: {:?}, EnclaveFeatureMask: {:?}, UserModeGlobalLogger: {:?}, Anonymous5: {:?} }}",
            self.NtSystemRoot,
            self.Reserved0,
            self.ProcessorFeatures,
            self.AlternativeArchitecture,
            self.Anonymous1,
            self.Anonymous2,
            self.Reserved12,
            self.Anonymous3,
            ...
            self.Anonymous4,
            self.CookiePad,
            self.EnclaveFeatureMask,
            self.UserModeGlobalLogger,
            self.Anonymous5
        )
    }
}
